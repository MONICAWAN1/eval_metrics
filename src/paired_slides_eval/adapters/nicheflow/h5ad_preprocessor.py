...
:func:`paired_slides_eval.adapters.nicheflow.preprocess.compute_pca`) into the
:class:`~paired_slides_eval.data.dataclass.H5ADDatasetDataclass` the niche-based code consumes:
...
from paired_slides_eval.adapters.nicheflow.graph import (
