...
def _standardize_generated_coords(generated, coord_transform):
    """Map a generated slide/niches' coordinates into the target's standardised
    frame.
    ...
    return GeneratedNiches(
        ...
        gt_x=generated.gt_x,
        gt_pos=generated.gt_pos,
        gt_ct=generated.gt_ct,
    )


def _detect_coord_space(gen_pos: np.ndarray, coord_transform) -> str:
    """Detect whether ``gen_pos`` is in the target's RAW frame (-> standardise)
    or already standardised.
...
def _reconcile_generated(generated, target, *, coords: str = "auto"):
    """Bring ``generated`` coordinates into the target's frame; return
    ``(generated, notes)``.
