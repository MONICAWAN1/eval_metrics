...
entry point (``python -m nicheflow_eval.classifier.train``) still exists for configured runs.
"""
...
def train_spatial_classifier(
    ...
    *,
    ...
    from nicheflow_eval.classifier.datamodule import H5ADCTDataModule
    from nicheflow_eval.classifier.nets import SpatialCTClassifierNet
    from nicheflow_eval.classifier.task import CellTypeClassification
