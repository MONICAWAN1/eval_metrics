...
``nicheflow_generator`` plugs into :func:`nicheflow_eval.pipeline.run.run_pipeline` as
...
from nicheflow_eval.adapters.nicheflow.generate import GenerationResult, generate
from nicheflow_eval.adapters.nicheflow.generator import nicheflow_generator, target_from_dataclass
